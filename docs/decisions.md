...
**Status:** Locked (direction). Implementation pending — tracked in `docs/plans/auth-readiness-system.md` (5 staged PRs). Graduate the settled parts to a `wiki/` explainer once shipped.
