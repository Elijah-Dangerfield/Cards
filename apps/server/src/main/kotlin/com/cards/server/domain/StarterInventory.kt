 ...
 * fresh profile + its starter rows commit in one transaction; existing
 * users get the same rows via the V18 migration's backfill block.
 *
 ...
 * means "the minimum so My Items isn't empty + each cosmetic family
 * (felt / card back / emoji blast) has at least one equippable default."
 */
