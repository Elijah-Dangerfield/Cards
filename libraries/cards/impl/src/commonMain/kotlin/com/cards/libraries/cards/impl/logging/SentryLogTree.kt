...
class SentryLogTree(
    ...
    /**
     * Error-level and above becomes a Sentry event, unless the throwable is one
     * [isExpectedFailure] recognises — those still breadcrumb and buffer
     * locally, they just never inflate error counts.
     *
    ...
    internal fun shouldCaptureEvent(entry: LogEntry): Boolean {
        ...
        return !throwable.isExpectedFailure()
    }
